...
### Invalid attributes [see complete list](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DEPRECATED-ATTRIBUTES.md)
...
### Deprecated tags [see complete list](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DEPRECATED-TAGS.md)
...
### DOM events [see complete list](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DOM-EVENTS.md)
...
## [Changelog](https://github.com/ghaschel/vscode-angular-syntax/blob/master/CHANGELOG.md)
