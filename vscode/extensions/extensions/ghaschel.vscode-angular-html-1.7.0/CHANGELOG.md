...
- Changed a lot of scope names for a more concise naming. See [scope names](https://github.com/ghaschel/vscode-angular-syntax/blob/master/SCOPE-NAMES.md) (Work in Progress)
...
- Initial support for invalid attributes in specific html tags. See [deprecated attributes](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DEPRECATED-ATTRIBUTES.md).
...
- Initial support for deprecated tags. See [deprecated tags](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DEPRECATED-TAGS.md).
...
- Support for DOM events. See [DOM events](https://github.com/ghaschel/vscode-angular-syntax/blob/master/DOM-EVENTS.md).
